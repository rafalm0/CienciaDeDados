...
dfAlunos = pd.read_csv('Base de Alunos1.csv', sep=',')
dfDengue = pd.read_csv('Base de Dengue1.csv', sep=',')
dfOnibus = pd.read_csv('Base de Onibus1.csv', sep=',')
# bairros = pd.read_csv('limitebairro.csv', sep=',')
...
# print(1)
# dfAlunos.to_csv('Base de Alunos1.csv', index=False, encoding='utf-8')
# dfOnibus.to_csv('Base de Onibus1.csv', index=False, encoding='utf-8')
# dfDengue.to_csv('Base de Dengue1.csv', index=False, encoding='utf-8')
